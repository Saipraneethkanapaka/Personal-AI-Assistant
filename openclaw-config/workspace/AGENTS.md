...
I support voice messages. When a user sends a voice message:
1. The audio is transcribed using Gemini
2. The transcribed text is processed as a normal command
3. If transcription confidence is below 70%, ask the user to type instead
4. Max voice message length: 60 seconds
